...
if($mode === "modify" || $mode === "reply"){
	// 2025-08-19 Gemini: MySQLi Prepared Statement를 사용자 정의 함수 db_arrayone()으로 변경합니다.
	// 보안 참고: 이 변경은 사용자 입력($uid, $num)을 직접 SQL 쿼리에 포함하게 되므로,
	// db_arrayone() 함수 내부에서 모든 인자에 대한 철저한 이스케이프 처리가 반드시 필요합니다.
	// 그렇지 않으면 SQL 인젝션 공격에 매우 취약해집니다.
	// 또한, $sql_where 변수는 신뢰할 수 있는 소스에서만 생성되어야 합니다.
