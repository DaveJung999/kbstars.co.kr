...
function write_ok($table, $qs){
	...
	$sql="INSERT
			...
			SET
				...
				cateuid ='" . (isset($qs['tid']) ? db_escape($qs['tid']) : '') . "',
				tid		='" . (isset($qs['tid']) ? db_escape($qs['tid']) : '') . "',
				p_seq		='" . (isset($qs['p_seq']) ? db_escape($qs['p_seq']) : '') . "',
				p_num		='" . (isset($qs['p_num']) ? db_escape($qs['p_num']) : '') . "',
				p_name		='" . (isset($qs['p_name']) ? db_escape($qs['p_name']) : '') . "',
				p_position		='" . (isset($qs['p_position']) ? db_escape($qs['p_position']) : '') . "',
				p_gubun		='" . (isset($qs['p_gubun']) ? db_escape($qs['p_gubun']) : '') . "',
				p_bdate		='" . (isset($qs['p_bdate']) ? db_escape($qs['p_bdate']) : '') . "',
				p_ddate		='" . (isset($qs['p_ddate']) ? db_escape($qs['p_ddate']) : '') . "',
				p_school		='" . (isset($qs['p_school']) ? db_escape($qs['p_school']) : '') . "',
				p_pro		='" . (isset($qs['p_pro']) ? db_escape($qs['p_pro']) : '') . "',
				p_height		='" . (isset($qs['p_height']) ? db_escape($qs['p_height']) : '') . "',
				p_oab		='" . (isset($qs['p_oab']) ? db_escape($qs['p_oab']) : '') . "',
				p_marry		='" . (isset($qs['p_marry']) ? db_escape($qs['p_marry']) : '') . "',
				p_family		='" . (isset($qs['p_family']) ? db_escape($qs['p_family']) : '') . "',
				p_cm		='" . (isset($qs['p_cm']) ? db_escape($qs['p_cm']) : '') . "',
				p_hobby		='" . (isset($qs['p_hobby']) ? db_escape($qs['p_hobby']) : '') . "',
				p_mplayer		='" . (isset($qs['p_mplayer']) ? db_escape($qs['p_mplayer']) : '') . "',
				p_nickname		='" . (isset($qs['p_nickname']) ? db_escape($qs['p_nickname']) : '') . "',
				p_spo		='" . (isset($qs['p_spo']) ? db_escape($qs['p_spo']) : '') . "',
				p_email		='" . (isset($qs['p_email']) ? db_escape($qs['p_email']) : '') . "',
				p_homepage		='" . (isset($qs['p_homepage']) ? db_escape($qs['p_homepage']) : '') . "',
				p_start		='" . (isset($qs['p_start']) ? db_escape($qs['p_start']) : '') . "',
				p_sin		='" . (isset($qs['p_sin']) ? db_escape($qs['p_sin']) : '') . "',
				p_end		='" . (isset($qs['p_end']) ? db_escape($qs['p_end']) : '') . "',
				p_lee		='" . (isset($qs['p_lee']) ? db_escape($qs['p_lee']) : '') . "',
				p_stress		='" . (isset($qs['p_stress']) ? db_escape($qs['p_stress']) : '') . "',
				p_music		='" . (isset($qs['p_music']) ? db_escape($qs['p_music']) : '') . "',
				p_life		='" . (isset($qs['p_life']) ? db_escape($qs['p_life']) : '') . "',
				p_food		='" . (isset($qs['p_food']) ? db_escape($qs['p_food']) : '') . "',
				p_trade		='" . (isset($qs['p_trade']) ? db_escape($qs['p_trade']) : '') . "'
				{$sql_set_file}
				{$sql_set}
		";
	db_query($sql);
