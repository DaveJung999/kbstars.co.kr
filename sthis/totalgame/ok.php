...
switch($_REQUEST['mode']){
	...
	case 'delete':
		...
		else $goto = 'listall.php?'.href_qs('uid=',$qs_basic);
		back('',$goto);
		break;
	default :
		...
		foreach($fieldlist as $value){
			...
			switch($value){
				...
				case 'docu_type' : // html값이 아니면 text로
					if(!isset($_POST['docu_type'])) $_POST['docu_type']=$dbinfo['default_docu_type'];
				...
				case 'tr_season' :
					$qs['tr_season']	= substr($_POST['data1'],2,2) .$_POST['data2'];
					break;
			} // end switch
