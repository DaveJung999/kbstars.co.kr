...
//if(!$_GET['priv']) $_GET['priv'] = 'person';
if(!$_GET['priv']) go_url('/sjoin/category.php');
$_SESSION['joinPriv'] = $_GET['priv'];
//=======================================================
...
// 템플릿 마무리 할당
$form_default = href_qs("priv={$_GET['priv']}","priv=",1);
$tpl->set_var("form_default",	$form_default);
$tpl->set_var("{$_GET['priv']}",	$_GET['priv']);
