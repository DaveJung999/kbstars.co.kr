		...
		<td height="23" colspan="2" bgcolor="<?= htmlspecialchars($dbinfo['color_sub_title'] ?? '', ENT_QUOTES, 'UTF-8') ?>"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td><img src="/sboard4/stpl/a_class/images/title_blue.gif" width="13" height="14" border="0" align="absmiddle"> <strong><span class="style11">시스템 정보</span> &nbsp; <img src="/sboard4/stpl/a_class/images/bar_menu.gif" width="3" height="16" border="0" align="absmiddle">&nbsp;
							<a href="#" onClick="document.sysconfig.submit();" onFocus="this.blur();"><img src="/sboard4/stpl/a_class/images/btm_save_0.gif" width="50" height="18" border="0" align="absmiddle" onMouseDown = "onDown(this);" onMouseOver = "onOver(this);" onMouseOut = "onOut(this);"></a>
</strong> </td>
				</tr>
		</table></td>
	</tr>
