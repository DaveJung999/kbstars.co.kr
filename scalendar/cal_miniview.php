			...
			For ($intNextDay=1; $intNextDay < 8;$intNextDay++) //요일단위 루프 시작, 일요일부터
			{
				...
				else  //
				{
					...
					else //입력날짜가 현재월에 해당되면
					{
						...
						{
							echo "<td   align=right valign=top><b><a href=diary.php?d=d&F_Year=".$intThisYear."&F_Month=".$intThisMonth."&F_Day=".$intPrintDay." ><font face=굴림 size=2 color=darkorange>".$intPrintDay."</font></a></b><br> \n";
						}
						elseif  ($intNextDay==1 ) //일요일이면 빨간 색으로
						{
							echo "<td bgcolor=white  align=right valign=top><a href=diary.php?d=d&F_Year=".$intThisYear."&F_Month=".$intThisMonth."&F_Day=".$intPrintDay." ><font face=굴림 size=2 color=red>".$intPrintDay."</font></a><br> \n";
						}
						else // 그외의 경우
						{
							echo "<td bgcolor=white  align=right valign=top><font face=굴림 size=2 color=#000000><a href=diary.php?d=d&F_Year=".$intThisYear."&F_Month=".$intThisMonth."&F_Day=".$intPrintDay." >".$intPrintDay."</a></font><br> \n";
						}
					}										
