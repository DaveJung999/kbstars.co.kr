...
<tr><td valign="middle">
	...
	<tr><td colspan="2" height="5"></td></tr>
	<tr>
		<td align="right"><font color="#008CD6"><?=$lang['change_admin_id']?>&nbsp;&nbsp;</font></td>
		<td><input type="text" class="input" name="admin_idx" size="15" value="<?=htmlspecialchars($admin_id ?? '')?>"></td>
	</tr>
	<tr>
		<td align="right"><font color="#008CD6"><?=$lang['change_admin_pass']?>&nbsp;&nbsp;</font></td>
		<td><input type="password" class="input" name="admin_passx" size="15"></td>
	</tr>
	<tr>
		<td align="right"><font color="#008CD6"><?=$lang['change_admin_repass']?>&nbsp;&nbsp;</font></td>
		<td><input type="password" class="input" name="admin_pass2x" size="15"></td>
	</tr>
	<tr><td colspan="2" height="5"></td></tr>
	<tr>
		<td></td>
		<td><input type="submit" value="<?=$lang['change_admin_change_button']?>" class="button"> <input type="button" value="<?=$lang['change_admin_close_button']?>" class="button" onclick="window.close()"></td>
	</tr>
