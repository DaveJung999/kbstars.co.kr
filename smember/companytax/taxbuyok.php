...
//=======================================================
	...
	// 공통적으로 사용할 $qs
	$qs=array(
			"from_cpid" =>  "post,trim,notnull=".urlencode('공급자 선택이 잘못되었습니다.')
 . ",checkNumber=".urlencode('공급자 선택이 잘못되었습니다.'),
			"to_cpid" =>  "post,trim,notnull,checkNumber=".urlencode('공급받는자 선택이 잘못되었습니다.')
 . ",checkNumber=".urlencode('공급받는자 선택이 잘못되었습니다.'),
			//"bid" =>  "post,trim",
			//"paymentrdate" =>  "post,trim",
			//"type" =>  "post,trim",
			"from_c_num" =>  "post,trim,notnull=".urlencode('공급자번호를 입력하십시요')
 . ",checkNumber=".urlencode('공급자번호를 입력하십시요'),
			...
			"to_c_num" =>  "post,trim,notnull=".urlencode('공급받는자 번호를 입력하십시요')
 . ",checkNumber=".urlencode('공급받는자 번호를 입력하십시요'),
